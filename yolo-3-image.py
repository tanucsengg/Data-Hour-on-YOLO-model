...
# path =  r'images\woman-working-in-the-office.jpg'
path = r'images\women-looking-financial-documents.jpg'
# or:
...
# img = cv2.imshow('Blob Image', cv2.cvtColor(blob_to_show, cv2.COLOR_RGB2BGR))
# # Waiting for any key being pressed
cv2.waitKey(0)
